...
public class BlogPostDAO {
    ...
    // sorting and displaying the post based on Date( Desc)
    ...
    // Displaying all the post using the given tag
    ...
    //Adding posts to Post Collections
    ...
    // Updating how many likes a post got
